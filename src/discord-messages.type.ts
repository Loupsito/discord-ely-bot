export const GENERIC_MESSAGES = {
  NOT_IN_SERVER: `Erreur : Vous n'êtes pas dans un serveur`,
  BYE: `Bye bye 👋`,
};
...
export const VOICE_CHANNEL_MESSAGES = {
  BOT_MUST_BE_IN_VOICE_CHANNEL: `Je ne suis actuellement pas dans un canal vocal`,
};
